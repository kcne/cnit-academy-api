...
INSERT INTO "new_Program" ("applicationDeadline", "coins", "description", "durationInDays", "founder", "id", "title") SELECT "applicationDeadline", "coins", "description", "durationInDays", "founder", "id", "title" FROM "Program";
DROP TABLE "Program";
...
INSERT INTO "new_User" ("email", "expiresAt", "firstName", "id", "isEmailVerified", "lastName", "password", "totalCoins", "updatedAt", "verificationCode") SELECT "email", "expiresAt", "firstName", "id", "isEmailVerified", "lastName", "password", "totalCoins", "updatedAt", "verificationCode" FROM "User";
DROP TABLE "User";
